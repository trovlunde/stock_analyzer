...
def bond_price(par, coupon_rate, periods, yield_rate):
    ...
    semi_annual_yield = (1 + yield_rate) ** 0.5 - \
        1  # Convert annual yield to effective semi-annual
    semi_annual_coupon = (coupon_rate * par) / 2  # Semi-annual coupon payment
    ...
    # Add present value of par value at maturity
